...
<section class="main-slider">
    <div class="container">
        <div class="main-slider-carousel owl-carousel owl-theme">
            ...
            <div><img src="/assets_client/images/background/4.png" alt></div>
            <div><img src="/assets_client/images/background/2.png" alt></div>
            <div><img src="/assets_client/images/background/3.png" alt></div>
        </div>
    </div>
</section>
                    ...
                    <div class="inner-box">
                        <div class="image" style="width: 300px; height: 400px;">
                            <a href="/movie-detail/{{ $value->slug_phim }}">
                                <div style>
                                    <img src="{{ $value->hinh_anh }}" alt style="object-fit: contain;" />
                                </div>
                            </a>
                            <div class="cart-box text-center mb-1">
                                <a class="cart" href="#" style><b>Trailer</b></a>
                                <a class="cart" style href="/movie-detail/{{ $value->slug_phim }}"><b>Đặt
                                        vé </b></a>
                            </div>
                        </div>
                        <div class="lower-content">
                            <h6><a href="/movie-detail/{{ $value->slug_phim }}"><b>{{ $value->ten_phim }}</b></a>
                            </h6>
                        </div>
                    </div>
                </div>
...
<section class="collection-section">
    <div class="auto-container">
        <div class="inner-container" style="border-radius: 20px; background: rgb(255,153,102);
            background: linear-gradient(90deg, rgba(255,153,102,1) 0%, rgba(255,94,98,1) 100%);">
            <div class="pattern-layer" style="background-image: url(/assets_client/images/icons/pattern-1.png)"></div>
            <div class="row clearfix">
                <div class="title-column col-lg-6 col-md-12 col-sm-12">
                    ...
                    <div class="deals text-white">NGƯỜI NHỆN: DU HÀNH VŨ TRỤ
                        NHỆN</div>
                    <a class="shop-now" href="shop-detail.html"><button class="btn btn-danger"><strong>ĐẶT VÉ
                                NGAY</strong></button></a>
                    <div class="arrow">
                        <img src="/assets_client/images/icons/arrow-1.png" alt />
                    </div>
                </div>
                <div class="image-column col-lg-6 col-md-12 col-sm-12">
                    <div class="image">
                        ...
                        <img src="/assets_client/images/resource/chair.png" alt />
                    ...
                    <div class="shop-item mix music photography col-lg-3 col-md-6 col-sm-12">
                        <div class="inner-box">
                            <div class="image" style="width: 300px; height: 400px;">
                                <a href="/movie-detail/{{ $value->slug_phim }}">
                                    <div style>
                                        <img src="{{ $value->hinh_anh }}" alt style="object-fit: cover;" />
                                    </div>
                                </a>
                                <div class="cart-box text-center mb-1">
                                    <a class="cart" href="/movie-detail/{{ $value->slug_phim }}"><b>Trailer</b></a>
                                    <a class="cart" href="/movie-detail/{{ $value->slug_phim }}">Đặt
                                        vé </a>
                                </div>
                            </div>
                            <div class="lower-content">
                                <h6><a
                                        href="/movie-detail/{{ $value->slug_phim }}"><b>{{ $value->ten_phim }}</b></a>
                                </h6>
                            </div>
                        </div>
                    </div>
        ...
        <div class="inner-container">
            <div class="sponsors-outer">
                <ul class="sponsors-carousel owl-carousel owl-theme">
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="/assets_client/images/clients/1.png" alt></a>
                        </figure>
                    </li>
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="/assets_client/images/clients/2.png" alt></a>
                        </figure>
                    </li>
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="/assets_client/images/clients/3.png" alt></a>
                        </figure>
                    </li>
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="/assets_client/images/clients/4.png" alt></a>
                        </figure>
                    </li>
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="/assets_client/images/clients/5.png" alt></a>
                        </figure>
                    </li>
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="/assets_client/images/clients/1.png" alt></a>
