                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3"> <label for="" class="mb-2">Tên Phim: </label>
                                <input type="text" id="ten_phim" class="form-control" placeholder="Nhập vào tên phim">
                            </div>
                            <div class="col-md-3"> <label for="" class="mb-2">Slug Phim: </label>
                                <input type="text" id="slug_phim" class="form-control" placeholder="Nhập vào slug phim">
                            </div>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-3"> <label for="" class="mb-2">Thể Loại: </label>
                                <input type="text" id="the_loai" class="form-control" placeholder="Nhập vào thể loại">
                            </div>
                            ...
                            <div class="col-md-3"> <label for="" class="mb-2">Ngôn ngữ: </label>
                                <input type="text" id="ngon_ngu" class="form-control" placeholder="Nhập vào ngôn ngữ">
                            </div>
                        </div>
                        <div class="row mt-2">
                            ...
                            <div class="col-md-3"> <label for="" class="mb-2">Trailer: </label>
                                <input type="text" id="trailer" class="form-control" placeholder="Nhập vào trailer">
                            </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-9">
                                            <label for="" class="mb-2">Mô tả: </label>
                                            <textarea name="mo_ta" id="e_mo_ta" cols="20" rows="10"
