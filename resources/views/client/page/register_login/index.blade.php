                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="account__login">
                                <div class="logo d-flex mb-4"> <img src="/assets_admin/images/logo-icon.png"
                                        style="width: 200px;" class="m-auto" alt="logo icon"></div>
                                <div class="account__login--header mb-25">
                                    <h2 class="account__login--header__title mb-10 text-center" style="color: #3e888b;">
                                        <b style="font-weight: 600; font-size: 3.5rem;">Đăng
                                            Nhập</b></h2>
                                ...
                                <div class="account__login--inner">
                                    ...
                                    <label>
                                        <input v-on:keyup.enter="loginAcc()" v-model="login.password"
                                            class="account__login--input" placeholder="Password" type="password">
                                    </label>

                                    <button v-on:click="loginAcc()" class="account__login--btn primary__btn">Đăng
                                        Nhập</button>

                                    <div class="account__login--divide">
                                        <span class="account__login--divide__text">CHƯA
                                            CÓ TÀI KHOẢN ? </span>
                                    </div>
                                    <div class="account__social d-flex justify-content-center mb-15">
                                        ...
                                        <a class="account__login--btn primary__btn text-center" style="width: 40%;"
                                    ...
                                    <p class="account__log--signup__text">Quên
                                        mật khẩu ? <a href="/forgot-password" type="button"><b class="text-danger">Đặt
                                                lại
                                                mật khẩu</b>
                                        </a></p>
                                </div>
